...
urlpatterns = [
    ...
    path('view_profile/current-user-id=<int:uid>/', user_views.view_profile, name='view-profile'),  # new
    ...
    path('login/', auth_views.LogoutView.as_view(template_name='users/login.html'), name='circle-logout'),
